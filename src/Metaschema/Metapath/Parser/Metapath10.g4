...
// Adapted for Metaschema Metapath 1.0
...
@header {
#pragma warning disable CS3021 // Type or member does not need a CLSCompliant attribute
using Metaschema.Metapath.Parser;
}
