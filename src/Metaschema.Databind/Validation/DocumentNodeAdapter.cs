...
using MetapathNodeType = Metaschema.Core.Metapath.Item.NodeType;
using DatabindNodeType = Metaschema.Databind.Nodes.NodeType;

namespace Metaschema.Databind.Validation;
